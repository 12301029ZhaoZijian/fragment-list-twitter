...
public class FirstFragment extends ListFragment {
     ...
     *
     * @param query1 Parameter 1.
     * @param tag Parameter 2.
     * @return A new instance of fragment FirstFragment.
     */
    public static FirstFragment newInstance(String query1, String tag) {
        FirstFragment fragment1 = new FirstFragment();
        Bundle args = new Bundle();
        args.putString(ARG_PARAM1, query1);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            query1 = getArguments().getString(ARG_PARAM1);
...
//    }
    ...
    public void onListItemClick(ListView L,View v,int position,long id){
        if (mListener!=null){
            ...
            String querySec = ((TextView) v).getText().toString();
            mListener.sendToSecondFrag(querySec);
        }
    }
